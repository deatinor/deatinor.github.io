...
var calculateAmmortization = function calculateAmmortization(principal, years, rate) {
    ...
    for (var y = 0; y < years; y++) {
        ...
        ammortization.push({ principalY: principalY, interestY: interestY, balance: balance });
    }
    return { monthlyPayment: monthlyPayment, monthlyRate: monthlyRate, ammortization: ammortization };
};
...
document.getElementById('calcBtn').addEventListener('click', function () {
    ...
    var _calculateAmmortizati = calculateAmmortization(principal, years, rate),
        monthlyRate = _calculateAmmortizati.monthlyRate,
        monthlyPayment = _calculateAmmortizati.monthlyPayment,
        ammortization = _calculateAmmortizati.ammortization;
    // console.log(monthlyRate);


    document.getElementById("monthlyPayment").innerHTML = monthlyPayment.toFixed(2);
    document.getElementById("monthlyRate").innerHTML = (monthlyRate * 100).toFixed(2);
    ammortization.forEach(function (month) {
